...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		boolean crossed = hasCrossedFinishLine();
		//5. If the robot has crossed the finish line... 
			if(crossed) {
				JOptionPane.showMessageDialog(null, "The robot finished! It travelled " + distance + " pixels!");
			}
			else {
				JOptionPane.showMessageDialog(null, "The robot didn't finish! It travelled " + distance + " pixels!");
